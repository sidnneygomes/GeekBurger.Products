...
namespace GeekBurger.Products.Service {
    public class ProductChangedService : IProductChangedService {
        ...
        public ProductChangedService(IMapper mapper, IConfiguration configuration, ILogService logService, IServiceProvider serviceProvider) {
            _mapper = mapper;
        ...
        public Message GetMessage(EntityEntry<Product> entity) {
            var productChanged = Mapper.Map<ProductChanged>(entity);
